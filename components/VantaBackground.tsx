...
export default function VantaBackground({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      <Script src="https://cdn.jsdelivr.net/npm/vanta@latest/dist/vanta.fog.min.js" strategy="afterInteractive" onLoad={initVanta} />
      <div 
        ref={vantaRef} 
        style={{ 
          minHeight: '100vh', 
      ...
      />
      <div style={{ position: 'relative', zIndex: 1, minHeight: '100vh', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1rem' }}>
        {children}
      </div>
    </>
  );
