...
export default function SignupPage() {
  ...
  return (
    <GoogleOAuthProvider
      clientId={process.env.NEXT_PUBLIC_GOOGLE_CLIENT_ID || "dummy_id"}
    >
      <VantaBackground>
        <div className="auth-card">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              />
              {errors.loginId && (
                <span className="form-error">{errors.loginId[0]}</span>
              )}
            </div>
            ...
            <div className="form-group">
              ...
              />
              {errors.mobile && (
                <span className="form-error">{errors.mobile[0]}</span>
              )}
            </div>
            ...
            <div className="form-group">
              ...
              {errors.role && (
                <span className="form-error">{errors.role[0]}</span>
              )}
            </div>
