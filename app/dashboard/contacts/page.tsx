...
export default function ContactsPage() {
  ...
  const avatarColors = ['#3b82f6', '#8b5cf6', '#0ea5e9', '#f59e0b', '#ef4444', '#10b981', '#ec4899'];
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                  <div style={{
                    ...
                    background: getColor(contact.name), color: 'white',
                  ...
                  <div>
                    ...
                    <span className={`badge badge-${contact.type.toLowerCase()}`} style={{ fontSize: '0.625rem' }}>
                      {contact.type}
                    </span>
                  </div>
                </div>
