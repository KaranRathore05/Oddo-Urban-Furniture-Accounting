...
interface Journal { id: string; name: string; type: string; defaultAccount: Account; }
        ...
        <div className="dash-card" style={{ marginBottom: '1.5rem' }}>
          ...
          <form onSubmit={handleCreate} style={{ display: 'flex', gap: '1rem', alignItems: 'flex-end', flexWrap: 'wrap' }}>
            <div className="form-group" style={{ flex: 1, minWidth: '180px', marginBottom: 0 }}>
              ...
              <input className="form-input" value={name} onChange={(e) => setName(e.target.value)} required placeholder="e.g. Petty Cash" />
            </div>
            ...
            <div className="form-group" style={{ flex: 1, minWidth: '200px', marginBottom: 0 }}>
              ...
              <select className="form-select" value={defaultAccountId} onChange={(e) => setDefaultAccountId(e.target.value)}>
