      ...
      <div className="data-table-wrap">
        ...
        {loading ? (
          ...
          <div className="empty-state">
            ...
            <Link href="/dashboard/purchase-orders" className="btn btn-secondary">Go to Purchase Orders</Link>
          </div>
        ) : (
          <table className="data-table">
            ...
            <tbody>
              {bills.map((bill) => (
                <tr key={bill.id} onClick={() => router.push(`/dashboard/vendor-bills/${bill.id}`)}>
                  <td style={{ color: 'var(--text-primary)', fontWeight: 500, fontFamily: 'monospace' }}>{bill.number}</td>
                  ...
                  <td style={{ textAlign: 'right', fontFamily: 'monospace' }}>₹{bill.amountPaid.toLocaleString('en-IN')}</td>
                  <td>
